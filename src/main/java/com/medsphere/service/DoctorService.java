...
public interface DoctorService {
    ...
    Doctor createNewDoctor(DoctorCreateForm form);

    Doctor update(Long id, DoctorForm form);

    DoctorForm getForm(Long id);

    List<User> getAvailableDoctorUsers(Long currentDoctorId);
}